...
const features = [
  new RaceFeature("Mental", "Ligons have an unusual mastery of Ki, gaining Max Ki/25 damage to Ki attacks (Charging does not affect this)."),
  new RaceFeature(
    "Physical",
  ...
  new RaceFeature("Mental", "Ligons are immune to their own type of 'Mind Freeze'."),
  new RaceFeature("Physical", "Due to their small size, Ligon always have +4 to Dodge rolls."),
  new RaceFeature(
    "Mental",
...
const Ligon = new Race({
  ...
  <br><br>
  Average Height: 3'5" (104 cm)<br>
  Average Weight: 80 pounds (36 kg)<br> 
  Life Span: 70-90 years. <br>
