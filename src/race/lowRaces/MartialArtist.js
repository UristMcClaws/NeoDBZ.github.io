...
const features = [
  ...
  new RaceFeature(
    'Physical',
    "'Martial Artist Aura' - When you declare the use of this ability with a power, it allows you to pay Ki costs by 'spending' your HP instead. or you can use it as a defensive Aura: This Aura costs 1 Ki for every 1 damage and is SP Resistant and may be used Reflexively. There is no limit to the amount of Ki that may be spent. Unlike other Auras, this may be used multiple times against Combo attacks. HP may not be used to fuel this Martial Artist Aura. The cost of this ability can never be reduced by more than 50% with suppression; even at 90% suppression."
  ),
  new RaceFeature(
    'Mental',
...
const powers = [
  new RacePower(
    'Trained',
    "This power is automatically obtained at Level 1. A Martial Artist chooses one of the powers granted to them by their first Regular School's power list; that power is considered to be three levels higher than it actually is. If you already have a power and gain a higher level as a result, they can't choose that power to be Trained. The School's Invent can be chosen.",
    'Mental'
  ),
  new RacePower(
    'Supreme Shield',
    "The Martial Artist must be Level 5 before taking this power. The Martial Artist can now use his 'Martial Artist Aura' to block one Unpreventable attack per round, at the cost of 1 Ki per 1 damage. There is no limit to the amount of Ki that can be spent. This ability counts as a reflexive shield, like his normal Martial Artist Aura. Suppress Powerlevel does not reduce the costs of this shield.",
    'Physical'
  ),
];
